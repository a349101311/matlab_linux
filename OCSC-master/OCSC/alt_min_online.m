...
if ~isempty(init)
    ...
    %d_small = randn(para.size_k); single() 11*11*100
    if (para.precS ==1)
    ...
    d = dsmall2d(d_small,para);  %����circshift i.e.���������Post���0����ͼƬ��Сһ�µĳߴ磬����ԭ�ȵ�Ԫ�طֲ�������
    d_hat = fft2(d); 
end
if (para.precS ==1)
    Mtb = single(Mtb);
...
imwrite(Frame.cdata,['/home/zhangqi/newOCSC/matlab_linux/OCSC-master/','graph/','7/','psnr.jpg']);
